                                ...
                                <div key={item.id} className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                                    <div className="flex justify-between items-start mb-5">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h3 className="font-bold text-gray-900 text-lg leading-tight">{item.bgName}</h3>
                                    ...
                                    <div className="space-y-3 mb-4">
                                        ...
                                        <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-50">
                                            <div className="grid grid-cols-2 gap-4">
                                                ...
                                                <div className="space-y-1">
                                                    <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Extend Expiry</span>
                                                    <p className="text-xs font-semibold text-gray-700">{item.extendExpiryDate ? formatDate(item.extendExpiryDate) : '-'}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
