...
const SharedDocuments = () => {
  ...
  // Helper function to check if date is within 15 days
  const isWithin15Days = (dateTimeStr: string): boolean => {
    ...
    try {
      ...
      // Reset time to start of day for accurate day difference calculation
      ...
      const diffTime = Math.abs(
        currentDateOnly.getTime() - itemDateOnly.getTime(),
      );
